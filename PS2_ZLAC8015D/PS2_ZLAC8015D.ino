...
void loop() {
  ...
  if (ps2x.ButtonPressed(PSB_GREEN) && digitalRead(5) == HIGH && digitalRead(6) == HIGH) {
    digitalWrite(5, LOW);
    digitalWrite(6, HIGH);
  }
  ...
  if (ps2x.ButtonPressed(PSB_PINK) && digitalRead(5) == HIGH && digitalRead(6) == HIGH) {
    digitalWrite(5, HIGH);
    digitalWrite(6, LOW);
  }
  ...
  if (ps2x.ButtonPressed(PSB_R1) && digitalRead(4) == HIGH) {
    digitalWrite(4, LOW);
  }
  else if (ps2x.ButtonPressed(PSB_R1) && digitalRead(4) == LOW) {
    digitalWrite(4, HIGH);
  }
