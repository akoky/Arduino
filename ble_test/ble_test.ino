...
static BLEUUID serviceUUID("00001812-0000-1000-8000-00805f9b34fb "); //Service UUID of fitnessband obtained through nRF connect application 
static BLEUUID    charUUID("00001812-0000-1000-8000-00805f9b34fb "); //Characteristic  UUID of fitnessband obtained through nRF connect application 
String My_BLE_Address = "ff:ff:11:05:14:b8"; //Hardware Bluetooth MAC of my fitnessband, will vary for every band obtained through nRF connect application 
